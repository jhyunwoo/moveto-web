...
export default function MenuBar() {
  ...
  return (
    <div className="fixed bottom-0 z-10 flex w-full items-end justify-center p-2 sm:bottom-auto sm:top-0 sm:items-start  sm:justify-between sm:p-0">
      ...
      <div className="flex w-full items-center justify-around space-x-2 rounded-full bg-white/80 p-2 shadow-lg backdrop-blur-sm dark:bg-slate-950/80 sm:justify-end sm:rounded-none sm:bg-slate-50/80 sm:p-2 sm:shadow-none sm:dark:bg-slate-950/80">
