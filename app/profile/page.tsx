...
function GuestPlanText({ children }: { children: ReactNode }) {
  return <div className="text-center text-lg">{children}</div>
}

function FreePlanText({ children }: { children: ReactNode }) {
  return (
...
function BasicPlanText({ children }: { children: ReactNode }) {
  return (
...
function ProPlanText({ children }: { children: ReactNode }) {
  return (
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <div className="flex flex-col items-start justify-center space-y-1 rounded-lg bg-white p-4 shadow-lg dark:bg-slate-900 sm:col-span-2">
          <div className="grid w-full grid-cols-4 place-content-center content-center items-stretch gap-1">
            ...
            {/* max upload size */}
            <SectionTitle>최대 업로드 크기</SectionTitle>
            <GuestPlanText>1GiB</GuestPlanText>
            <FreePlanText>10GiB</FreePlanText>
            <BasicPlanText>100GiB</BasicPlanText>
            <ProPlanText>1TiB</ProPlanText>
