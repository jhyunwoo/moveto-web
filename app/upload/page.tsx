...
export default function Upload() {
  ...
  return (
    <CenterLayout>
      ...
      <div className='flex w-full max-w-xl flex-col items-center justify-center rounded-lg bg-white p-4 shadow-xl'>
        <div className='flex w-full justify-around space-x-1 rounded-full bg-slate-100 p-1'>
          <button
            type='button'
